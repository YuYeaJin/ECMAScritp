...
//  property: .lengtrh -> 문자열의 길이
console.log(s1, ", length=", s1.length);

//  문자열 추출 메서드 : 기본적으로 제로베이스
...
console.log("1st Search:", pos); // 첫번째 자바의 위치
pos = s1.indexOf("Java", pos + 4);  // 검색 시작 위치 재정의
console.log("2nd Search:", pos); // 두 번째 Java의 위치
pos = s1.indexOf("Java", pos + 4); // 검색어를 찾지 못함
console.log("No Kerword:", pos);    // -1: 없음

pos = s1.lastIndexOf("Script");     // 뒤로부터 앞으로
