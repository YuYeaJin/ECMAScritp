...
//  NaN가 포함된 연산의 결과는 언제나 NaN
console.log(v, "* 3", "=", v * 3);
//  number 데이터가 NaN인지 확인하려면 isNaN합수
console.log(v, "is NaN?", isNaN(v));

console.log("============== Infinity")
console.log("1/0 =", 1/0);

//  유한수(Finite) 확인 함수 (Infinity)
...
// InFinty와 수치형 데이터의 산술연산 -> Infinity
let result = 1 /0 + 2024;
